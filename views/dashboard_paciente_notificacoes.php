        ...
        <div class="notificacoes-lista">
            <?php foreach ($notificacoes as $notif): ?>
                <div class="notificacao-item <?php echo $notif['lida'] ? 'lida' : 'nao-lida'; ?> <?php echo $notif['tipo']; ?>">
                    <div class="notificacao-icone" style="color: var(--primary);">
                        <?php
                        $icone = '';
                        switch ($notif['tipo']) {
                            case 'agendamento':
                                ...
                                break;
                            case 'confirmacao':
                                $icone = '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 11l3 3L22 4"></path><path d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>';
                                break;
                            case 'cancelamento':
                            ...
                            case 'pagamento':
                                ...
                                break;
                            case 'lembrete':
                                $icone = '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"></path><path d="M13.73 21a2 2 0 0 1-3.46 0"></path></svg>';
                                break;
                            default:
